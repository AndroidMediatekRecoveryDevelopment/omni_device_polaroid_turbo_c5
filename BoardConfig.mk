...
LOCAL_PATH := device/polaroid/turbo_c5
...
BOARD_MKBOOTIMG_ARGS  := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board v5E2E-0
TARGET_PREBUILT_KERNEL := device/polaroid/turbo_c5/kernel
...
# RECOVERY
TARGET_RECOVERY_FSTAB := device/polaroid/turbo_c5/twrp.fstab


# PARTTIONS
# We need the partitions size in decimal
# Use cat proc/partitions via adb, then block size * 1024
# This is the partitions of polaroid ROM, system size is bigger than Android One ROM
